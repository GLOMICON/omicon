 ...
 * [omicon.yml](omicon.yml)
     * Determines how your purl.obolibrary.org/obo/omicon/ redirects will be handled
     ...
     * Paste in the contents of [omicon.yml](omicon.yml)
 ...
 * [omicon.md](omicon.md)
     ...
     * Paste in the contents of [omicon.md](omicon.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
